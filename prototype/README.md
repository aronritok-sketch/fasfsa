...
- Design tokens, type scale, 12-column grid and components from blueprint §2 and §6. Colors are the blueprint palette, with Instrument Serif and Inter self-hosted as WOFF2 (OFL licensed).
...
Photo frames are placeholders until the photo shoot happens. The blueprint rules out stock photos of people.
